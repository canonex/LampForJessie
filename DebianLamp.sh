...
apt-get -y install ssh expect debconf-utils fail2ban iptables
...
echo "						- Apache"
#php5-mysql
apt-get install -y php5 php5-mysqlnd libapache2-mod-php5 php5-mcrypt php5-curl php-apc libssh2-php git
